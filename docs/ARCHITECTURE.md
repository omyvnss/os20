...
|-----------|----------------|--------------|
| **CLI** (`cli/`) | npm package `os20-cli` | Checks Docker, clones/pulls the app, starts/stop/status/logs/update/reset |
| **Container** | `ghcr.io/omyvnss/os20:latest` | The OS20 frontend + server, prebuilt |
